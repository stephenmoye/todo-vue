/* Features to add */ /* - Editable text on click - Multiple todo lists -
export/import todo list as text file - repositioning of todos >> across multiple
lists */
      ...
      <div class="col-xs-12">
        ...
        <ul class="list-group">
          <li
            ...
            v-bind:class="{ strikeT: todos[index].isCompleted }"
